...
const AuthLogin = () => {
  ...
  const { login, actualizarPasswordDeUsuario } = useAuth(); // ✅ Use the real login from JWTContext
  ...
  const handleHashedPassword = async (usuario, password) => {
    try {
      await actualizarPasswordDeUsuario(usuario, password);
    } catch (error) {
      console.log(error);
    }
  };
        ...
        {({ errors, touched, values, handleSubmit, isSubmitting, handleChange, handleBlur }) => (
          <form noValidate onSubmit={handleSubmit}>
            <Grid container spacing={3}>
              ...
              <Grid size={12}>
                <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ mt: -1 }}>
                  ...
                  />
                  <MuiLink component={RouterLink} to="#" color="white" variant="h6">
              ...
              <Grid size={12}>
                <AnimateButton>
                  <Button disableElevation disabled={isSubmitting} fullWidth size="large" type="submit" variant="outlined" color="white">
            ...
            <button
              ...
              type="button"
              onClick={() => handleHashedPassword(values.email, values.password)}
            >
              X
            </button>
          </form>
