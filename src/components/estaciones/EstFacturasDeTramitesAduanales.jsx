...
const EstFacturasDeTramitesAduanales = () => {
  //Estados
  ...
  const [opcionDeDesgloze, setOpcionDeDesgloze] = useState(1);
  ...
  const handleDesglozar = (e) => {
    console.log('aki', e);
    setOpcionDeDesgloze(e);
  };
    ...
    <Paper square={false} elevation={4} sx={{ p: 4, width: { xs: '95vw', lg: '50vw' }, margin: '0 auto' }}>
      <Box sx={{ backgroundColor: '' }}>
        ...
        <Box component="section">
          <Typography variant="h2">Facturas de Trámites Aduanales Web</Typography>
        </Box>
...
export default EstFacturasDeTramitesAduanales;
