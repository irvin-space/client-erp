...
const PermitirQuitarConcepto = ({isEnable}) => {
  ...
  return (
    <div>
      <Button disabled={!isEnable} variant="outlined" onClick={handleOpen} startIcon={<MinusCircleOutlined  />}>
      ...
      <Modal open={open} onClose={handleClose} aria-labelledby="modal-modal-title" aria-describedby="modal-modal-description">
        ...
        >
          ...
          {/* Mensaje */}
          <Box>
            <Typography sx={{ mb: 2 }} variant="h5">Este proceso requiere de una Clave de Autorización para continuar</Typography>
            <Typography sx={{ mb: 2 }} variant="h5">
              Autorización de Proceso: <span>Eliminar conceptos de un Trámite Aduanal</span>
            </Typography>
          </Box>
          ...
          <Grid sx={{ mb: 2, display: 'flex', justifyContent: 'center' }} container spacing={2}>
            <Grid sx={{ backgroundColor: '' }} size={8}>
              <ComponenteListaDinamica
                ...
                // value= sucursal
              />
              {/* <TextField label="Clave del Usuario:" variant="outlined" /> */}
              <Box sx={{ display: 'flex', justifyContent: 'center' }}>
                {/* <TextField label="Clave del sistema" /> */}
...
export default PermitirQuitarConcepto;
