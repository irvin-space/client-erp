...
const MetodoDePagoModal = ({ isEnable }) => {
      ...
      <Modal open={open} onClose={handleClose} aria-labelledby="modal-modal-title" aria-describedby="modal-modal-description">
        ...
        >
          ...
          <Box sx={{ backgroundColor: { xs: '', sm: '', md: '', lg: '', xl: '' } }}>
            <Typography variant="h4">Registro de Cuenta de Banco</Typography>
          </Box>
          <Divider sx={{ mb: 2 }} />
          {/*Cliente*/}
            ...
            <Grid size={12}>
              <MuiTablaBase
                ...
                estructuraEncabezados={[
                  { propiedad: 'test1', encabezadoTitulo: 'Método Pago' },
                  { propiedad: 'test2', encabezadoTitulo: 'Banco' },
                  { propiedad: 'test3', encabezadoTitulo: 'CLABE' },
                  { propiedad: 'test4', encabezadoTitulo: 'Cuenta' },
                ]}
              />
            </Grid>
          </Grid>
...
export default MetodoDePagoModal;
