...
export default function Theme9test(colors, mode) {
  const { grey } = colors;
  const greyColors = {
    0: grey[0],
    50: grey[1],
  ...
  let primaryColors = [
    '#e6f0f7', // 50 - Very light tint (backgrounds)
    '#b3d1e6', // 100
    '#80b2d6', // 200
    '#4d93c5', // 300
    '#267aad', // 400
    '#00345D', // 500 - Your brand color (main)
    '#002b4a', // 600 - Slightly darker
    '#001f37', // 700
    '#001324', // 800
    '#000711' // 900 - Near black (for depth)
  ];
